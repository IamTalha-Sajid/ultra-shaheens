...
const Journey: React.FC = () => {
  const milestones = [
    ...
    },
    {
      ...
      description: "Ultra Shaheens met in Islamabad for an away-match screening of Pakistan vs Jordan. Under the lights with our banner and our colours, we brought stadium energy to the capital — chants, pride, and one more unforgettable night together.",
    ...
    },
    {
      ...
      description: "The match was behind closed doors, so we could not be in the stands for this home fixture. Ultra Shaheens gathered for a community screening of Pakistan vs Myanmar in the AFC Asian Cup 2027 Qualifiers, sharing the same nerves, chants, and pride as we closed out the campaign together.",
